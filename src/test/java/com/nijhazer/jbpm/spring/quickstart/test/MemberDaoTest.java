package com.nijhazer.jbpm.spring.quickstart.test;

import java.util.List;

import junit.framework.Assert;

import com.nijhazer.jbpm.spring.quickstart.domain.Member;
import com.nijhazer.jbpm.spring.quickstart.repo.MemberDao;
